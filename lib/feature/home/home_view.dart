...
import 'package:firebase_news_app/feature/home/home_provider.dart';
...
import 'package:firebase_news_app/feature/home/sub_view/home_serach_delegate.dart';

import 'package:firebase_news_app/product/widgets/card/home_news_card.dart';
...
import 'package:firebase_news_app/product/widgets/card/recommended.dart';

part './sub_view/home_chips.dart';

final _homeProvider = StateNotifierProvider<HomeNotifier, HomeState>((ref) {
  return HomeNotifier();
}); //Burada static atiyor parcaladigi widget kullanmak icin
...
class _HomeViewState extends ConsumerState<HomeView> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() {
      //mevcut senkron kod çalıştıktan hemen sonra, ancak diğer asenkron işlemlerden
      //(zamanlayıcılar, dosya girdi/çıktısı, ağ istekleri gibi) önce çalıştırmak için kullanılır.
